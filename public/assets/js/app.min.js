var app = {
                ...
                app.isMobile || !PerfectScrollbar
                    ...
                    : ((t =
                        ...
                        (e.closest("." + app.sidebar.class)
                            ? (app.sidebar.scrollBarDom = new PerfectScrollbar(e, {
                                wheelPropagation: t,
                            }))
    ...
    handleSidebarMenuToggle = function (a) {
        a.map(function (e) {
            e.onclick = function (e) {
                ...
                (!document.querySelector("." + app.sidebar.minify.toggledClass) ||
                    window.innerWidth < 992) &&
                    (slideToggle(t),
                        a.map(function (e) {
                        ...
                        (e = t.closest("." + app.sidebar.menuItemClass)).classList.contains(
                ...
                e.onclick = function (e) {
                    ...
                    e &&
                        (e.classList.contains(app.sidebar.minify.toggledClass)
                            ? (e.classList.remove(app.sidebar.minify.toggledClass),
                                localStorage.removeItem(app.sidebar.minify.localStorage))
                            : (e.classList.add(app.sidebar.minify.toggledClass),
                                localStorage.setItem(app.sidebar.minify.localStorage, !0)));
                };
            }),
            "undefined" != typeof Storage &&
    ...
    handleSidebarMinifyFloatMenuClick = function () {
        ...
        e &&
            e.map(function (e) {
                e.onclick = function (e) {
                    e.preventDefault();
                    var e = this.closest("." + app.sidebar.menuItemClass).querySelector(
                        "." + app.sidebar.menuSubmenuClass
                    ),
                                ...
                                setInterval(function () {
                                    ...
                                    if (
                                        ...
                                        var i = document.querySelector(
                                            app.floatSubmenu.id + " ." + app.floatSubmenu.class
                                        );
                                        if (r < o && i)
                                            for (
                                                var p = app.floatSubmenu.overflow.class.split(" "), c = 0;
                                                c < p.length;
                                                c++
                                            )
                                                i.classList.add(p[c]);
            ...
            e.map(function (e) {
                (e.onmouseenter = function () {
                    ...
                    if (
                        ...
                        var t = this.closest("." + app.sidebar.menuItemClass).querySelector(
                            "." + app.sidebar.menuSubmenuClass
                        );
                        if (
                            ...
                            if (a) {
                                var o = getComputedStyle(document.body),
                                    ...
                                    s = parseInt(
                                        document.querySelector("." + app.sidebar.class).clientWidth
                                    ),
                                    s =
                                ...
                                if (document.querySelector("#" + app.floatSubmenu.id)) {
                                    ...
                                    r.setAttribute("data-offset-top", t),
                                        r.setAttribute("data-menu-offset-top", t),
                                        (i.innerHTML = a);
                                } else {
                                    var r = "",
                                        d =
                                            (s < l && (r = app.floatSubmenu.overflow.class),
                                                document.createElement("div")),
                                        r =
                                            (d.setAttribute("id", app.floatSubmenu.id),
                                                d.setAttribute("class", app.floatSubmenu.class),
                                                d.setAttribute("data-offset-top", t),
                                                d.setAttribute("data-menu-offset-top", t),
                                                (d.innerHTML =
                                                    '\t<div class="' +
                                                    app.floatSubmenu.container.class +
                                                    " " +
                                ...
                                (l = document.querySelector(
                                    ...
                                    (i = document.querySelector("#" + app.floatSubmenu.id));
                                l < s - t
                                    ? i &&
                                    ((i.style.top = t + "px"),
                                        (i.style.left = n + "px"),
    ...
    handelTooltipPopoverActivation = function () {
        [].slice
            ...
            [].slice
                .call(document.querySelectorAll("[" + app.popover.toggleAttr + "]"))
                .map(function (e) {
    ...
    handleScrollToTopButton = function () {
        var a = [].slice.call(
            document.querySelectorAll("[" + app.scrollTopButton.toggleAttr + "]")
        );
    ...
    handleThemePageControl = function () {
        ...
        [].slice
            ...
            .map(function (o) {
                o.onclick = function () {
                    for (
                        var e = this.getAttribute(app.themePanel.themeList.toggleAttr),
                        t = 0;
                        ...
                        [].slice
                            ...
                            .map(function (e) {
                                e != o
                                    ? e
                                        .closest("li")
                                        .classList.remove(app.themePanel.themeList.activeClass)
                                    : e
                                        .closest("li")
                                        .classList.add(app.themePanel.themeList.activeClass);
                            }),
                        handleCssVariable(),
                        setCookie(app.themePanel.themeList.cookieName, e),
                        document.dispatchEvent(
                            new CustomEvent(app.themePanel.themeList.onChangeEvent)
                        );
                };
            }),
