    ...
    (() => {
                            ...
                            "bottom" === a
                                ...
                                : "top" === a
                                    ...
                                    : "left" === a
                                        ...
                                        : "right" === a &&
                                        n.css({ top: e.top + (l / 2 - u / 2), left: e.left + s }),
                                n.addClass("in");
                        },
                    },
                    {
        ...
        r()(document).on("click.note-dropdown-menu", function (t) {
            r()(t.target).closest(".note-btn-group").length ||
                (r()(".note-btn-group.open .note-btn.active").removeClass("active"),
                    ...
                    e &&
                        ...
                        (t.attr({ "aria-label": e.tooltip }),
                            t
                                .data(
                                    "_lite_tooltip",
                                    new Go(t, { title: e.tooltip, container: e.container })
                                )
                                .on("click", function (t) {
                        ...
                        t.data("_lite_dropdown", new Jo(t, { container: e.container })),
                ...
                function (t, e) {
                    var o = Array.isArray(e.items)
                        ? e.items.map(function (t) {
                            ...
                            return (
                                i.html([In(e.checkClassName), " ", n]).data("item", t), i
                            );
                        })
                        : e.items;
                    t.html(o).attr({ "aria-label": e.title }),
                        ...
                        mn({
                            ...
                            callback: function (o) {
                                o.find(".note-holder").each(function () {
                                    ...
                                    "fore" === e
                                        ? (o.find(".btn-background-color").hide(),
                                            o.css({ "min-width": "210px" }))
                                        : "back" === e &&
                                        (o.find(".btn-foreground-color").hide(),
                                            o.css({ "min-width": "210px" }));
                            },
                            click: function (o) {
                                var n = r()(o.target),
